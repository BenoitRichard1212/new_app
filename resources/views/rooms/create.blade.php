     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" style="height:150px" name="temp_min" placeholder="Temp min"></textarea>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Sensor Floor:</strong>
                <textarea class="form-control" style="height:150px" name="sensor_floor" placeholder="Sensor Floor"></textarea>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Sensor Wall:</strong>
                <textarea class="form-control" style="height:150px" name="sensor_wall" placeholder="Sensor Wall"></textarea>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
